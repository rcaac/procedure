<template>
    <div>
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" @click="$emit('closeModalDocument'), $emit('getSent')" aria-label="Close">
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="container col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2" v-if="this.reception_date === null">
                                        <div class="input-group">
                                            <button
                                                type="button"
                                            ...
                                            >
                                                <i :class="{ 'icon-plus': this.tupa === 0, 'icon-check': this.tupa === 1 }"/>
                                                Trámite Tupa
                                            </button>
                                        </div>
                                    </div>                                    
                                    ...
                                    <div class="col-md-2" v-if="this.reception_date === null">
                                        <div class="input-group">
                                            <button
                                                ...
                                                :class="{'btn btn-primary btn-sm': this.annexes === '0' || this.annexes === null || this.annexes !== null, 'btn btn-success btn-sm': this.annexes=== '1'}"
                                            >
                                                <i :class="{'icon-plus': this.annexes === '0' || this.annexes === null || this.annexes !== null, 'icon-check': this.annexes=== '1'}"/>
                                                Anexos
                                            </button>
                                        </div>
                                    </div>
        ...
        <component
            ...
            @closeModal="closeModalRequirement($event)"
...
<script>
    ...
    import ModalRequirement from '../../components/modals/ModalRequirement';
    ...
    export default {
        ...
        methods: {
            ...
            getDocument(id)
            {
                axios.get(`${this.ruta}/documentModalInternal/${id}`)
                    .then((response) => {
