        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> USUARIOS ELIMINADOS
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-md-4">
                            <div class="input-group">
                                <input type="text" v-model="search" @keyup="listUserTrashed(1,search)" class="form-control form-control-sm" placeholder="Texto a buscar">
                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                        <tr v-for="user in arrayUserTrashed" :key="user.id">
                            <td v-text="user.firstName"></td>
                            <td v-text="user.lastName"></td>
                            <td v-text="user.dni"></td>
                            <td v-text="user.phone"></td>
                            <td v-text="user.email"></td>
                            <td>&nbsp;
                                <button type="button" class="btn btn-outline-danger btn-sm" @click="deleteEntity(user.id)">
...
<script>
    export default {
        ...
        methods : {
            listUserTrashed(page, search) {
                let me=this;
                var url= this.ruta + '/user/listUserTrashed?page=' + page + '&search=' + search;
                axios.get(url).then((response) => {
                    var res= response.data;
                    me.arrayUserTrashed = res.personTrashed.data;
            ...
            changePage (page) {
                ...
                me.listUserTrashed(page, this.search);
            },
            deleteEntity (id) {
                Swal.fire({
                    ...
                    if (result.value) {
                        let me = this;
                        axios.delete(this.ruta + '/user/' + id + '/delete').then(() => {
                            me.listUserTrashed(1,this.search);
                            Swal.fire(
                                'Eliminado!',
        ...
        mounted () {
            this.listUserTrashed(1, this.search);
        }
    }
</script>
