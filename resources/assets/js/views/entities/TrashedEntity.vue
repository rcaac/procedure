    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Entidades Eliminadas
            </div>
            <div class="card-body">
                <div class="form-group row">
                    <div class="col-md-4">
                        <div class="input-group">
                            <input type="text" v-model="search" @keyup="listEntityTrashed(1,search)" class="form-control form-control-sm" placeholder="Texto a buscar">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                        <tr v-for="entity in arrayEntityTrashed" :key="entity.id">
                            ...
                            <td>&nbsp;
                                <button type="button" class="btn btn-outline-danger btn-sm" @click="deleteEntity(entity.id)">
...
<script>
    export default {
        ...
        methods : {
            listEntityTrashed(page, search) {
                let me=this;
                var url= this.ruta + '/entity/trashed?page=' + page + '&search=' + search;
                axios.get(url).then((response) => {
                    var res               = response.data.listTrashed;
                    me.arrayEntityTrashed = res.data;
            ...
            changePage (page) {
                ...
                me.listEntityTrashed(page, this.search);
            },
            deleteEntity (id) {
                Swal.fire({
                    ...
                    if (result.value) {
                        let me = this;
                        axios.delete(this.ruta + '/entity/' + id + '/delete').then(() => {
                            me.listEntityTrashed(1,this.search);
                            Swal.fire(
                                'Eliminado!',
        ...
        mounted () {
            this.listEntityTrashed(1, this.search);
        }
    }
</script>
